 ...
 * @author USER
 */
@WebServlet(name = "Svnuevocliente", urlPatterns = {"/Svnuevocliente"})
public class Svnuevocliente extends HttpServlet {
...
String nombrecliente=request.getParameter("nombredecliente");        
 ...
 clp.crearCliente(apellido, celular, direccion, dni, email, fnacimiento, nacionalidad, nombrecliente);
