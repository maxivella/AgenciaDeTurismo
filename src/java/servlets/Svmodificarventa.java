...
/*if(codempleado!=null && idPaquete!=null && dni!=null)*/ clp.editarVenta(idVenta, idPaquete, serviciosAdicionales, mediodepago, apellido, celular, codempleado, direccion, dni, email, fecha, fnacimiento, nacionalidad, nombrecliente);
// public void editarVenta(int idVenta, int idpaquete, List<String[]> listaIdServiciosAdicionales, String mediodepago, String apellido, String celular, String codempleado, String direccion, String dni, String email, String fecha, String fnacimiento, String nacionalidad, String nombrecliente) {        
        //(idVenta, idPaquete, serviciosAdicionales, mediodepago, apellido, celular, codempleado, direccion, dni, email, fecha, fnacimiento, nacionalidad, nombrecliente);
